...
- record the repository owner's policy-output-independent review of all 12 candidates: 11 agreements and one unadjudicated disagreement;
- retain `v2_scenario_012` as an invalid evaluation unit requiring adjudication and record the nonblocking ecological-validity concern for `v2_scenario_007`;
